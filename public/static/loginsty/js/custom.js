$(function() {
    ...
    $(".openlogin").click(function() {
    	$.ajax({
    		type:'get',
    		url:"/extend/ajax-login/ajaxlogin.php",
    		data:"enews=loginwindow&t="+Math.random(),
    		dataType:'html',
    		success:function(html)
    		{
    			$("#loginalert").html(html).css("top") && ($("#loginalert").show(), $(".loginmask").fadeIn(500), $("#loginalert").animate({
    	            top: 0
    	        },
    	        400, "easeOutQuart"))
    			/*
