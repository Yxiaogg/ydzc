<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"D:\xampp\htdocs\ydzc/application/cner\view\rental\add.html";i:1531876854;}*/ ?>
<!DOCTYPE HTML>
...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" value="" placeholder="租房名字"  id="rental_name" name="rental_name">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" autocomplete="off" value="" placeholder="租房地址" id="rental_address" name="rental_address">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" autocomplete="off" value="" placeholder="租房面积" id="rental_area" name="rental_area">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" autocomplete="off"  placeholder="租金" id="rental_price" name="rental_price">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<input type="text" class="input-text" autocomplete="off"  placeholder="类型" id="rental_class" name="rental_class">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<script id="editor" name="rental_des" type="text/plain" ></script> 
	...
	<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<div class="uploader-thum-container">
							<input type="hidden"  placeholder="" id="main_img_url" name="rental_src" value="">
