<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\xampp\htdocs\ydzc/application/index\view\rental\rentaldetail.html";i:1531876854;}*/ ?>
<!DOCTYPE html>
...
<title><?php echo $rentalInfo['rental_name']; ?></title>
...
var UA = window.navigator.userAgent,
    ...
    if (IsAndroid || IsIOS || IsWindowsPhone) {
...

        {
            ...
            var ReturnLinkUrl = "<?php echo url('mobile/rental/rentaldet',['rid'=>$rentalInfo['rental_id']]); ?>";
    ...
    <div class="detail-title">
      ...
      <div class="big-ewm">
        ...
        <img id="share-link-contact-qrcode1"  src="__STATIC__/travel/images/ewm.png" alt="">
            ...
            <h2><?php echo $rentalInfo['rental_name']; ?></h2>
      ...
      <div class="di-left clearfix">
        ...
        <div class="di-slide">
          ...
          <ul class="img-wrap-list" >
              ...
              <li style="display:block;"><div class="cell"><img src="__STATIC__/<?php echo $rentalInfo['rental_src']; ?>" style="width: 400px;height: 300px;"  alt=""></div>
          ...
          <p style="border:none;">租金：<span class="font1"><?php echo $rentalInfo['rental_price']; ?></span>/月</p>          

          <p>类型：<span class="font2"><?php echo $rentalInfo['rental_class']; ?></span></p>

          <p>地址：<span class="font2"><?php echo $rentalInfo['rental_address']; ?></span></p>

       

          <p>地铁线路：

                    <span class="font2"><?php echo getRentalSubway($rentalInfo['rental_subway']); ?></span>
          ...
          <p>出租面积：<span class="font3"><?php echo $rentalInfo['rental_area']; ?>平米</span></p>
  ...
  <div class="connect-wrap">
    ...
    <div class="five-wrap">
      ...
      <div class="project-description">
        ...
        <p><?php echo $rentalInfo['rental_des']; ?></p>
