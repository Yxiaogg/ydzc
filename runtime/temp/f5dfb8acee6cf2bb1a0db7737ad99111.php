<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\xampp\htdocs\ydzc/application/index\view\fdcase\fdcase.html";i:1531972571;}*/ ?>
<!DOCTYPE html>
          ...
          <?php if(is_array($sale) || $sale instanceof \think\Collection || $sale instanceof \think\Paginator): $i = 0; $__LIST__ = $sale;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
					...
					<div class="img-word">
						...
						<div class="img-middle">
						   ...
						   <a href="<?php echo url('sale/saleDetail'); ?>?sale_id=<?php echo $vo['sale_id']; ?>"><img style="width: 1000px;height: 640px;" src="__STATIC__/<?php echo $vo['sale_src']; ?>"  alt="<?php echo $vo['sale_name']; ?>"></a>
