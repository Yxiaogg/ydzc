<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/data/home/qxu1590200456/htdocs/application/index/view/rental/rental.html";i:1522291297;}*/ ?>
<!DOCTYPE html>
...
var UA = window.navigator.userAgent,
    ...
    if (IsAndroid || IsIOS || IsWindowsPhone) {
        ...
        var host = window.location.host
         ...
         if(linkurl.indexOf("rental")>0 || linkurl.indexOf("sale")>0 || linkurl.indexOf("contact")>0 || linkurl.indexOf("s")>0 || linkurl=="http://yingdizichan.com/" || linkurl.indexOf("building")>0||linkurl=="http://yingdizichan.com/index/index/index.html"||linkurl=="http://www.yingdizichan.com/"|| linkurl=="http://www.yingdizichan.com/index/index/index.html")

        {

            var ReturnLinkUrl = "<?php echo url('mobile/rental/index'); ?>";
...
<body>
   ...
   <style>#nav_1 {text-decoration: none;  border-radius: 4px; background: #5ea629;}</style>
  ...
  <div class="mar-wrap">
    ...
    <div class="nav-search clearfix">
      ...
      <p class="bread"><a href="<?php echo url('index/index'); ?>">首页</a>&nbsp; &gt; &nbsp;<a href="javascript:;">房屋出租</a></p>
    ...
    <div class="xzl-wrap">
                ...
                <div class="all-options"> 
                    ...
                    <p class="op-style">
                      ...
                      <?php if(is_array($subway) || $subway instanceof \think\Collection || $subway instanceof \think\Paginator): $i = 0; $__LIST__ = $subway;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <span id="s"><a href="javascript:;" id="sub" <?php if($sub == $vo['subway_num']): ?>class="cur"<?php endif; ?> onclick="subway(<?php echo $vo['subway_num']; ?>)"><?php echo $vo['subway_name']; ?></a></span> 
                    ...
                    <div class="ao-wrap clearfix"><p class="options-name">面积：</p><p class="op-style">
                      ...
                      <?php if(is_array($area) || $area instanceof \think\Collection || $area instanceof \think\Paginator): $i = 0; $__LIST__ = $area;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <span><a href="javascript:;" id="area" <?php if($ar == $vo['area_num']): ?>class="cur"<?php endif; ?> onclick="area(<?php echo $vo['area_num']; ?>)"><?php echo $vo['area_name']; ?></a></span> 

                      <?php endforeach; endif; else: echo "" ;endif; ?></p>

                        <!-- <span><a href="javascript:;" class="" onclick="area(50)">50平米以下</a></span>  

                        <span><a href="javascript:;" class="" onclick="area(100)">100平米以下</a></span>   -->

                    </div>  



                     <div class="ao-wrap clearfix"><p class="options-name">租金：</p><p class="op-style">
                      ...
                      <?php if(is_array($renprice) || $renprice instanceof \think\Collection || $renprice instanceof \think\Paginator): $i = 0; $__LIST__ = $renprice;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <span><a href="javascript:;" id="price" <?php if($pr == $vo['renprice_num']): ?>class="cur"<?php endif; ?> onclick="price(<?php echo $vo['renprice_num']; ?>)"><?php echo $vo['renprice_name']; ?></a></span> 

                      <?php endforeach; endif; else: echo "" ;endif; ?></p>

                        <!-- <span><a href="javascript:;" class="" onclick="price(50)">50元以下</a></span> 

                        <span><a href="javascript:;" class="" onclick="price(100)">100元以下</a></span>  -->
      ...
      <div class="result-wrap clearfix">
        ...
        <div class="right-side">
          ...
          <?php if(is_array($rentalRole) || $rentalRole instanceof \think\Collection || $rentalRole instanceof \think\Paginator): $i = 0; $__LIST__ = $rentalRole;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>

          <div class="ad-img">

            <div class="table-cell">

              <a href="<?php echo url('rental/rentalDetail'); ?>?rental_id=<?php echo $vo['rental_id']; ?>"><img style="width: 230px;height: 190px;" src="__STATIC__/<?php echo $vo['rental_src']; ?>"></a>
                  ...
                  <div class="floor-wrap clearfix floor-hover">
                        ...
                        <div class="xzl-img">
                              ...
                              <div class="xi-cell">
                                    ...
                                    <a href="<?php echo url('rental/rentalDetail'); ?>?rental_id=<?php echo $vo['rental_id']; ?>" target="_blank" ><img src="__STATIC__/<?php echo $vo['rental_src']; ?>"  style="width: 200px;height: 130px;" alt="<?php echo $vo['rental_name']; ?>"></a>
                        ...
                        <div class="xzl-info">
                              ...
                              <div class="dui-wrap clearfix">
                                    ...
                                    <div class="lou-title"><a href="<?php echo url('rental/rentalDetail'); ?>?rental_id=<?php echo $vo['rental_id']; ?>" title="<?php echo $vo['rental_name']; ?>"><?php echo $vo['rental_name']; ?></a></div>

                              </div>

                              <p class="keyword" style="color: red"><span>租金:<?php echo $vo['rental_price']; ?>元/月</span><span></span><span></span></p>

                              <p class="keyword" style="font-size: 15px"><span>地址：<?php echo $vo['rental_address']; ?></span></p>

                              <p class="people">面积：<span><?php echo getRentalArea($vo['rental_area']); ?></span></p>

                              <p class="people">类型：<span><?php echo $vo['rental_class']; ?></span></p>
            ...
            <div class="mar-wrap">
                  ...
                  <p>
                        ...
                        <span>
                              ...
                              <a href="" target="_blank">蜀ICP备18003460号</a> 
